...
MAFIA_ROLECARD_MAPPING = {
    ...
    '3': ['**[ACTIVE][1-SHOT]** Upgrade your factional kill tonight to pierce through any protection your target may have.'],
    '4': ['**[ACTIVE][1-SHOT]** Upgrade your factional kill tonight to pierce through any protection your target may have.'],
    ...
    '8': ['**[ACTIVE]** Roleblock a player of your choice, preventing them from using any active abilities for the night.'],
    '9': ['**[ACTIVE]** Redirect a player of your choice, making them target another player of your choice instead.'],
    'a': ['**[ACTIVE][1-SHOT]** Pick a player of your choice. When they die, their alignment and rolecard will not be revealed.']
...
TOWN_ROLECARD_MAPPING = {
    ...
    'c': ['**[ACTIVE]** Guard a player of your choice. If they are killed during the night, you will die in their place.'],
    'd': ['**[ACTIVE]** Guard a player of your choice. If they are killed during the night, you will die in their place.']
}
